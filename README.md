...
Este dataset se distribuye bajo la licencia CC BY 4.0. El contenido de los datos proviene de fuentes públicas del Gobierno de Tucumán. La licencia aplica a la forma de recopilación, limpieza y estructuración de los datos en este repositorio como así también a cualquier herramienta, script de procesamiento o análisis incluido en este repositorio.

Consulte el archivo LICENSE para obtener más detalles sobre los términos y condiciones de uso.
